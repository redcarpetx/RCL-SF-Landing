...
<div class="mc-field-group">
	<label for="mce-CITY">Your City </label>
	<input type="text" value="" name="CITY" class="" id="mce-CITY">
</div>
<div class="mc-field-group input-group">
    <strong>I'm a Hero </strong>
    <ul><li><input type="checkbox" value="1" name="group[12505][1]" id="mce-group[12505]-12505-0"><label for="mce-group[12505]-12505-0">I am a hero myself, and would love to join your community of influencers.</label></li>
</ul>
</div>
